...
<html>
  ...
  <head>
    <title> Manager Login | VIIT Canteen </title>
  </head>
...
<div class="container">
    <div class="container">
    	...
    	<div class="list-group">
    		<a href="myrestaurant.php" class="list-group-item ">VIIT Canteen</a>
 ...
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="dprice" name="dprice" value=<?php echo $row1['price'];  ?> placeholder="Your Product Price (INR)" required="">
          </div>

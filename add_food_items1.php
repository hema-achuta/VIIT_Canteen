...
$query = "INSERT INTO FOOD(name,price,description,R_ID,images_path,qty) VALUES('" . $name . "','" . $price . "','" . $description . "','" . $R_ID ."','" . $images_path . "','" . $qty . "')";
...
if (!$success){
  ...
  <script type="text/javascript" src="js/bootstrap.min.js"></script>
    ...
    <div class="jumbotron">
     <h1>Oops...!!! </h1>
     <p>Kindly enter your  details before adding food items.</p>
